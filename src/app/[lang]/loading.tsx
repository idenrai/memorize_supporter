    ...
    <div className="min-h-screen flex flex-col items-center pt-24 px-4 sm:px-8">
      ...
      <header className="w-full max-w-5xl flex items-center justify-between mb-24">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-gray-800 rounded-xl flex items-center justify-center animate-pulse">
            <Brain className="text-gray-600 w-6 h-6" aria-hidden="true" />
          </div>
      ...
      <main className="w-full max-w-5xl">
        ...
        <div className="flex items-center gap-2 mb-6">
          <Library size={20} className="text-gray-600" aria-hidden="true" />
          <div className="h-6 w-32 bg-gray-800 rounded animate-pulse"></div>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="bg-[#1c1f26] border border-gray-800 rounded-2xl p-6 h-48 flex flex-col animate-pulse">
              ...
              <div className="mt-auto flex justify-end pt-4 border-t border-gray-800/50">
