...
export const en: Translations = {
  ...
  home: {
    ...
    manageDecks: "Data Management",
    loadingSamples: "Loading sample decks…",
    alreadyHaveJson: "Already have a JSON file? Go to Data Management",
    quickStartSampleTitle: "Start with Sample Decks",
    quickStartSampleDesc: "Load pre-configured decks with a single click to experience flashcards and quiz modes immediately.",
    quickStartCustomTitle: "Create Your Own Decks",
    quickStartCustomDesc: "Convert your study materials using AI prompts, or import pre-made JSON files directly.",
  ...
  prep: {
    ...
    desc: "Transform your notes, textbooks, and vocabulary lists into study-ready decks using AI prompts. Simply copy a template prompt and paste it into ChatGPT, Claude, or any LLM.",
...
(Paste your textbook excerpt, word list, or lecture notes here)`,
    ...
    tabPrompt: "AI Generator Prompt",
    tabJson: "JSON Template",
    downloadJson: "Download JSON Template",
    jsonCopied: "JSON template copied to clipboard.",
    jsonCopyFailed: "Failed to copy JSON.",
    schemaBadge: "JSON Schema",
    terminalLabelPrompt: "LLM INSTRUCTION",
    ...
    copyJson: "Copy JSON",
    compatNote: "※ Existing 'practice_quiz' JSON files remain 100% compatible and supported.",
  },
  management: {
    cancel: "Cancel",
    ...
    needHelpTemplate: "Need the correct file format?",
    checkTemplatesInPrep: "Check template formats in Data Preparation",
    sortBy: (column: string) => `Sort by ${column}`,
    schemaLabel: "FORMAT",
    browseFiles: "Browse Files",
    editDeck: "Edit Deck Info",
    editDeckTitle: "Deck Title",
    editDeckSeries: "Series / Category",
    editDeckSeriesPlaceholder: "Category name (optional)",
    deckTitleRequired: "Deck title is required.",
    deckUpdateSuccess: "Deck info updated successfully.",
...
4. [One-Line Exam Takeaway]: High-yield mnemonic or summary rule for fast recall during the actual exam`,
    ...
    practiceQuiz: "Multiple-Choice Quiz",
    question: "Question",
    ...
    shortcutHard: "Hard",
    shortcutEasy: "Easy",
    pressSpaceOrClick: "Press Space or click to reveal",
  ...
  records: {
    ...
    emptyDesc: "Take an exam in multiple-choice quiz decks to record your scores and review mistakes.",
    ...
    manageBackupLink: "Data Management & Backup",
    reviewExam: "Review Questions",
    filterAll: "All Questions",
    filterIncorrect: "Incorrect Only",
    examReviewTitle: "Exam Question Review",
    examReviewSubtitle: (deckTitle: string) => `Session Breakdown: ${deckTitle}`,
    examSessionInfo: (date: string, count: number) => `Session Date: ${date} · ${count} Questions`,
    passCriteriaNotice: (passMark: number) => `Passing criteria: ${passMark}% or higher`,
  },
  local: {
    ...
    recordsHeader: (count: number) => `Total: ${count}`,
    passedBadge: "Passed",
  ...
  about: {
    ...
    feat1Desc: "Study using flashcards with intuitive flip interaction, realistic multiple-choice quizzes, and vocabulary decks tailored to each format.",
    ...
    techSubtitle: "Engineering Architecture & Core Specifications",
    ...
    shortcutChoiceTitle: "Instant Option Selection",
    shortcutChoiceDesc: "Press keys 1 to 4 to select options and submit instantly.",
    ...
    techSpecArchCat: "Architecture",
    techSpecArchItem: "Local-First Client DB",
    techSpecArchDetail: "Persistent IndexedDB + BroadcastChannel multi-tab sync",
    techSpecFwCat: "Framework",
    techSpecFwItem: "Next.js 16 (App Router)",
    techSpecFwDetail: "React 19 full-stack static & client rendering",
    techSpecStyleCat: "Styling",
    techSpecStyleItem: "Tailwind CSS v4",
    techSpecStyleDetail: "@theme token-based Precision Dark UI system",
    techSpecCognitiveCat: "Learning Logic",
    techSpecCognitiveItem: "Active Recall & Smart Retry Loop",
    techSpecCognitiveDetail: "Immediate retrieval cues & targeted reinforcement queue",
    techSpecStateCat: "Schema Validation",
    techSpecStateItem: "Zod Type-Safe Schema",
    techSpecStateDetail: "Runtime deck integrity validation & strict type inference",
    techSpecDistCat: "Platform & Offline",
    techSpecDistItem: "PWA (Service Worker)",
    techSpecDistDetail: "Service worker offline App Shell caching & PWA installation",
  },
};
