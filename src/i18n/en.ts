...
(Paste your textbook excerpt, word list, or lecture notes here)`,
    ...
    title: "Study Deck Data Preparation",
    tabPrompt: "AI Generator Prompt",
    tabJson: "Template JSON Schema",
...
4. [One-Line Exam Takeaway]: High-yield mnemonic or summary rule for fast recall during the actual exam`,
  ...
  about: {
    ...
    techSpecArchItem: "Zero-Server Local-First",
    techSpecArchDetail: "Native IndexedDB + BroadcastChannel multi-tab sync",
    techSpecFwCat: "Framework",
    techSpecFwItem: "Next.js 16 (App Router)",
    techSpecFwDetail: "React 19 Server Components + Client Islands",
    techSpecStyleCat: "Styling",
    techSpecStyleItem: "Tailwind CSS v4",
    techSpecStyleDetail: "High-Focus Precision Canvas Theme Tokens",
    techSpecCognitiveCat: "Cognitive Engine",
    techSpecCognitiveItem: "Ebbinghaus SRS Algorithm",
    techSpecCognitiveDetail: "Exponential decay spaced repetition model",
    techSpecStateCat: "State & Validation",
    techSpecStateItem: "React 19 + Zod",
    techSpecStateDetail: "Client IndexedDB local state integration & strict Zod schema validation",
    techSpecDistCat: "Distribution",
    techSpecDistItem: "Progressive Web App (PWA)",
    techSpecDistDetail: "Full offline service worker caching",
  },
};
