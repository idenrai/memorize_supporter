...
> 컴포넌트의 외부 기능과 동작을 100% 보존하면서 폴더 구조 개편, 대규모 코드 스멜(Long Method, God Component) 제거, 순수 소스코드 품질 개선을 수행할 때는 본 워크플로우 대신 반드시 `[.agents/workflows/refactor.md](file:///Users/idenrai/project/memorize_supporter/.agents/workflows/refactor.md)` 워크플로우를 실행하십시오.
